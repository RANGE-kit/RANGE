...
dftbp_exe_path = '/global/homes/z/zdf/bin/dftb+' 
calculator_command_line = dftbp_exe_path + "   > job.log "
geo_opt_control_line = dict(method='DFTB+', input='input_dftbp_template.hsd') # This input will be your input script
...
optimization = GA_ABC(computation.obj_func_compute_energy, cluster_boundary,  # From previous definitions
                      ...
                      max_iteration=3,         # The max number of iterations
